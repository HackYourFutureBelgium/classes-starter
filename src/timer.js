...
export class Timer {
    ...
    check = () => {
        const startStopSound = new Audio('../public/assets/sounds/time-countdown.mp3');
        startStopSound.play();
    ...
    start = () => {
        this.tick();
        this.intervalId = setInterval(this.tick, this.intervalSeconds)
        this.onStart();
    };
    ...
    //  function to be called every intervalSeconds
    tick = () => {
        if (this.timeLeft <= 0) {
            this.stop();
            this.onComplete();
    ...
    // action(s) will be done when timer tike
    onTick() {
    ...
    onComplete() {
        ...
        const completedSound = new Audio('../public/assets/sounds/clock-countdown.mp3');
        completedSound.play();
    ...
    getSeconds(str) {
        ...
        const seconds = parseInt(strArr[0]) * 60 + parseInt(strArr[1]);
        return seconds;
    }
